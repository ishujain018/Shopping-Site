		...
		<div class="container">
			...
			<div class="wthreehome-latest-grids">
				<div class="col-md-6 wthreehome-latest-grid wthreehome-latest-grid1">
					...
					<h4>DENIM TOPS</h4>
					<h5>Classy Tops For Women</h5>
					<h6><a href="womens.jsp">Shop Now</a></h6>
				</div>
				...
				<div class="col-md-6 wthreehome-latest-grid wthreehome-latest-grid4">
					...
					<h4>BEACH WEAR</h4>
					<h5>Groovy Material</h5>
					<h6><a href="mens.jsp">Shop Now</a></h6>
				</div>
			</div>
			<div class="clearfix"></div>
	...
	<div class="wthreewinter-coll">
		<div class="container">
			...
			<div class="wthreeshop-a">
				<a href="womens.jsp">SHOP WINTER COLLECTION</a>
			</div>
		</div>
	</div>
	<!-- //Winter-Collection -->
		...
		<div class="style-grids">
			<div class="col-md-6 style-grid style-grid-1">
				...
				<div class="style-grid-1-text">
					<h3>DENIM JEANS</h3>
					<p>Contrary to popular belief, Lorem is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock.</p>
					<div class="wthreeshop-a">
						<a href="womens.jsp">SHOP DENIM COLLECTION</a>
					</div>
				</div>
			</div>
			<div class="col-md-6 style-grid style-grid-2">
				<div class="style-image-1">
					...
					<div class="style-grid-2-text">
						...
						<p>Contrary to popular belief, Lorem is not simply random text. It has roots in a piece of classical Latin literature from 45 BC.</p>
					</div>
				</div>
